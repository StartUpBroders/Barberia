...
public class ControladorAutenticacion {
    ...
    private SesionRespuesta convertir(UsuarioAutenticado u){return new SesionRespuesta(true,u.getUsername(),u.getRol(),new BarberiaRespuesta(u.getBarberiaId(),u.getBarberiaNombre(),u.getBarberiaSlug(),null,null,null,true),u.getProfesionalId()==null?null:new ProfesionalRespuesta(u.getProfesionalId(),u.getProfesionalNombre(),null,true));}
}
